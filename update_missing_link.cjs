// Script to add many links to MissingLinkGame.tsx
const fs = require('fs');
...
const newLinks = `
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'فراشة', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/Monarch_Butterfly_Danaus_plexippus.jpg/500px-Monarch_Butterfly_Danaus_plexippus.jpg' }
    ]
  },
  {
...
content = content.replace(
  /export function MissingLinkGame.*?const \[showChat, setShowChat\] = useState\(true\);/s,
  selectUI
);
...
console.log('Missing link modifications complete!');
